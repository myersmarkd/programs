 ...
 *
 * The AddAppointmentController allows for the user to create an appointment.
 * 
 * @author myers
 */
public class AddAppointmentController implements Initializable {
    ...
    void saveButtonAction(ActionEvent event) throws IOException {
        ...
        {   //Convert form start time and date into timestamp for DB addition
            ...
            {   //Send information to the DB
                DBSQLCalls.addAppointment(title, description, location, type, startTimestamp, 
     ...
     * in the combo boxes for user selection.
     */
    @Override
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //Translates the labels to French
        if (Locale.getDefault().getLanguage().equals("fr"))
        {
            rb = ResourceBundle.getBundle("utility/French", Locale.getDefault());
            addAppointmentLabel.setText(rb.getString("Add Appointment"));
